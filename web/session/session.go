...
func DefaultRedisManagerConfig(conn string) *ManagerConfig  {
	return &ManagerConfig{CookieName:"sessionid",Gclifetime:3600,EnableSetCookie:true,ProviderConfig:conn}
}
